...
?>
<div class="header-bar-wrapper <?php 
    if ( $sticky_menu ) echo ' sticky';
    if ( $background_placement == 'Under Header' && $slides_images && !$sticky_menu ) echo ' pos-abs'; 
?>">
    ...
    <div class="header-bar">
        ...
        if( $secondary_menu == true ) :
            include( locate_template( 'menus/secondary_menu.php' ) );
        endif;

        $menu_type = get_field( 'menu_type', 'option' );

        if( $menu_type == 'Regular' ):
            include( locate_template( 'menus/regular_menu.php' ) );
        elseif ( $menu_type == 'Split by Logo in center' ) :
            include( locate_template( 'menus/split_menu.php' ) );
        elseif ( $menu_type == 'Logo Centered & Above Menu' ) :
            include( locate_template( 'menus/above_menu.php' ) );
        endif; ?>
