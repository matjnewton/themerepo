...
function product_scripts_method() {
	wp_enqueue_script( 'product_scripts', get_stylesheet_directory_uri() . '/js/product_scripts.js' );
	wp_localize_script( 'product_scripts', 'localize_var', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ) ) );
	wp_register_style('product_css', get_stylesheet_directory_uri() .'/css/product.css', array(),'', 'all');
	wp_enqueue_style('product_css');
	wp_register_script('jquerystickyjs', get_stylesheet_directory_uri() . '/js/jquery.sticky.js', array('jquery'), '', true);
	wp_enqueue_script( 'jquerystickyjs' );
	wp_register_script('bxslider_min_js', get_stylesheet_directory_uri() . '/js/jquery.bxslider.min.js', array('jquery'), '', true);
	wp_enqueue_script( 'bxslider_min_js' );
	wp_register_style('bxslider_css', get_stylesheet_directory_uri() .'/css/jquery.bxslider.css', array(),'', 'all');
	wp_enqueue_style('bxslider_css');
} 

function custom_admin_theme_style() {
    wp_enqueue_style('custom-admin-style', get_stylesheet_directory_uri() .'/css/custom_admin_style.css');
}
